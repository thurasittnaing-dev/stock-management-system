                ...
                @forelse ($withdraw_histories as $history)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <button type="button" data-toggle="modal" data-target="#returnModal{{ $history->id }}"
                                    class="btn btn-sm btn-primary">Put Back</button>
                                <!-- Return  Modal -->
                                <div class="modal fade" id="returnModal{{ $history->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <form action="{{ route('return_history.store') }}" method="POST"
                                                autocomplete="off">
                                                @csrf
                                                @method('POST')

                                                <input type="hidden" name="withdraw_history_id"
                                                    value="{{ $history->id }}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="date"
                                                                class="form-control flatpicker" required>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>Qty</label>
                                                            <input type="number" name="qty" class="form-control"
                                                                min="1" max="{{ $history->qty }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-check col-md-6 ml-2">
                                                            <input class="form-check-input" name="is_final"
                                                                id="is_final" type="checkbox" value="1" checked>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-check col-md-6 ml-2">
                                                            <input class="form-check-input" name="is_damaged"
                                                                id="is_damaged{{ $history->id }}"
                                                                onchange="handleIsDamaged('{{ $history->id }}')"
                                                    ...
                                                    <div id="damage_form{{ $history->id }}" style="display: none;">
                                                        <div class="row">

                                                            <input type="hidden" name="stock_id"
                                                                value="{{ $history->stock_id }}">

                                                            <input type="hidden" name="withdrawer_id"
                                                                value="{{ $history->withdrawer_id }}">
...
@section('js')
    ...
    <script>
        let handleIsDamaged = (id) => {
            $(`#damage_form${id}`).toggle();
        }
