...
@section('content')
    <div class="container-fluid">
        <div class="my-2 d-flex justify-content-start p-0">
            <div>
                @php
                    ...
                    $is_final = $_GET['is_final'] ?? '';
                    $is_damage = $_GET['is_damage'] ?? '';
                @endphp
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="is_final" id="" class="form-control select2">
                                                <option value="">--Select--</option>
                                                <option {{ '1' == $is_final ? 'selected' : '' }} value="1">Final
                                                </option>
                                                <option {{ '0' == $is_final ? 'selected' : '' }} value="0">In
                                                    Usage</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="is_damage" id="" class="form-control select2">
                                                <option value="">--Select--</option>
                                                <option {{ '1' == $is_damage ? 'selected' : '' }} value="1">Damaged
                                                </option>
                                                <option {{ '0' == $is_damage ? 'selected' : '' }} value="0">Fine
                                                </option>
                                            </select>
                                        </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @forelse ($return_histories as $history)
                    <tr>
                        <td>{{ ++$i }}</td>
                        <td>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge badge-warning">In Usage</span>
                            @endif
                        </td>
                        <td>
                            @if ($history->is_damage)
        ...
        {!! $return_histories->appends(request()->input())->links() !!}
    </div>
@stop
